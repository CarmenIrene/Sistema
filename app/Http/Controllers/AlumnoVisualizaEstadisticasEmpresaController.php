...
{
     public function AlumnoVisualizaEstadisticas(){ //va el nombre de la tabla
    	...
    	return view('AlumnoVisualizaEstadisticasEmpresa')->with('AlumnoVisualizaEstadisticas',
    	$VisualizaEst); //nombre de la vista y nombre de la tabla
    }
}
