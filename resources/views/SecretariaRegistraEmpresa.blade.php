  ...
  <div class="container">
   ...
   <form action="" style="top: 200px; position: relative">
      <div class="tituloDatosAsesor" style="background-color:rgb(26,50,86); width: 78%; top: -190px; left: 122px; position: relative">
        <p>REGISTRO DE UNA NUEVA EMPRESA</p>
      </div><!--DIV TITULO DATOS ASESOR-->  
        <!--DIV que contiene los datos que se le piden al asesor-->
        <div class="Asesor" style="height: 500px; width: 78%; position: relative;top:-190px; left: 122px">
          ...
          <div class="row" style="width: 78%; margin-left:30px; margin-bottom: 10px"><!--DIV row3-->
           ...
           <div class="row" style="width: 78%; margin-left:30px; margin-bottom: 20px"><!--DIV row4-->
                <div class="col-3 colum11 -sm" style="height: 44px; left: 20px; text-align: left;background-color: rgb(26,50,86); top: 40px" >
                  <p>Escriba aquí sus comentarios:</p>
                    </div>
                  <div class="col-9 actividades" style="top: 40px; left: 24px">
           ...
           <div class="row" style="width: 78%; margin-left:30px; margin-bottom: 10px"><!--DIV row5-->
            <div class="col-7 inputCargoAs -sm" style="top:50px; left: 50%; padding: 0px">
              <button type="button" class="btn btn-info"> Registrar Empresa</button>
            </div>                  
          </div><!--DIV row5--->         
        </div>  <!--DIV Asesor--> 
